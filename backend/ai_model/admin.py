...
class AIModelAdmin(admin.ModelAdmin):
    list_display = [
        ...
        'is_active', 'random_only', 'supports_streaming', 'is_thinking_model', 'is_fresh_model', 'capabilities_display',
        'created_at'
    ]
    list_filter = ['provider', 'model_type', 'is_active', 'random_only', 'supports_streaming', 'is_thinking_model', 'is_fresh_model', 'created_at']
