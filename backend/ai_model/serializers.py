...
class AIModelSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'max_tokens', 'supports_streaming', 'is_active', 'is_thinking_model', 'is_fresh_model',
            'release_date', 'created_at', 'win_rate', 'total_usage', 'url'
        ]
...
class AIModelListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'capabilities', 'supported_languages', 'is_active', 'release_date', 'model_type', 'is_thinking_model', 'url', 'random_only'
        ]
