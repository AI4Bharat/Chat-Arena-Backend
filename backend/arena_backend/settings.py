...
# Database Configuration - Use SQLite for local dev
...
# ============================================================================
# HYBRID WSGI+ASGI CONFIGURATION
# ============================================================================

# Container type (set via environment variable)
CONTAINER_TYPE = os.getenv('CONTAINER_TYPE', 'wsgi')  # 'wsgi' or 'asgi'

# Enable async views (for ASGI containers)
USE_ASYNC_VIEWS = os.getenv('USE_ASYNC_VIEWS', 'False').lower() == 'true'

# Log container configuration
if DEBUG:
    import sys
    print(f'Container Type: {CONTAINER_TYPE}', file=sys.stderr)
    print(f'Async Views Enabled: {USE_ASYNC_VIEWS}', file=sys.stderr)
...
# ============================================================================
# DATABASE CONFIGURATION FOR HYBRID WSGI+ASGI
# ============================================================================

# Connection lifetime - reuse connections to reduce overhead
# WSGI: Longer connections (workers handle sequential requests)
# ASGI: Shorter connections (async handles concurrent requests)
if CONTAINER_TYPE == 'asgi':
    # ASGI: Shorter lived connections
    DATABASES['default']['CONN_MAX_AGE'] = 300  # 5 minutes
else:
    # WSGI: Longer lived connections
...
# Note: Using psycopg2 (sync driver)
# For true async DB, consider upgrading to psycopg3 in future
# ASGI containers will use sync_to_async for ORM queries
